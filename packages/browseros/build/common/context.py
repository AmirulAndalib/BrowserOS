...
class Context:
    ...
    def get_winsparkle_tool_path(self) -> Path:
        """Get winsparkle-tool.exe path for signing"""
        return join_paths(self.get_winsparkle_dir(), "bin", "winsparkle-tool.exe")
